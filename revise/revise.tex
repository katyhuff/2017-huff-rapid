...
\begin{solution}
I have added, to the caption, more detail about this timestep updating syntax and all other symbols used in this figure. 
\end{solution} 
...
\question Page  9,  line  150-151:  ``is  the  average  concentration throughout the degraded volume'' at which point (j or k), or at the 
...
\begin{solution}
This seemed like a great idea, so I tried it (see below). However, I'm not convinced it 
	isn't actually more confusing, so I have chosen not to make this
change. If the reviewer feels strongly that the below image is more clear, I
can certainly make this change, but I do feel like it may actually add to the confusion.
\end{solution} 
...
are contaminant masses in this context. I have adde d areminder of this to the
...
in the paper only and did not appear in the code itself. 
\end{solution} 
...
I hope that common differential equation boundary conditions of this type are well
...
\begin{solution}
        I'm sorry to say that I don't understand this comment. Section 2.3 is after, not 
